...
limited resource of display registers, 16 in total. In addition it reduces the size of the generated
code as it avoids having to generate a prolog and epilog for every minor scope. The main class
responsible for manging this is \texttt{Frame}. It lays out the combined locals of all minor scopes
in a given major scope. It does so via an algorithm identical to the record layout algorithm
...
\noindent We will proceed lay out the locals. We will express our layout using a C structure.
